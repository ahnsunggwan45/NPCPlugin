...
class EntityNPC extends Living
{
    ...
    public function initEntity(): void
    {
        ...
        if ($this->namedtag->getTag('npcEntityId') !== null) {
            $id = $this->namedtag->getInt('npcEntityId');
            $height = EntityConfig::HEIGHTS[$id];
            $width = EntityConfig::WIDTHS[$id];
            $this->width = $width;
            $this->height = $height;
    ...
    public function sendSpawnPacket(Player $player): void
    {
        ...
        $packet->type = $this->namedtag->getInt("npcEntityId");
    ...
    public function saveNBT(): void
    {
        ...
        $this->namedtag->setInt("npcEntityId", $this->namedtag->getInt("npcEntityId"));
    }
}